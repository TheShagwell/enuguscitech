...
<?php require_once './inc/header.php'; ?>
            ...
            <main id="main-container">
                ...
                <div class="content content-full">
                    <!-- Overview -->
                    <h2 class="font-w300 mt-4 mb-3">Messages</h2>
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-lg-12 invisible" data-toggle="appear" data-timeout="150">
                            <div class="block block-rounded block-fx-pop text-center">
                                <div class="block-content block-content-full d-flex justify-content-center align-items-center">
                                    <div>
                                        <a class="link-fx text-primary font-size-h1 font-w600" href="javascript:void(0)"><?= GET_TOTAL('contacts'); ?></a>
                                        <div class="font-size-sm font-w600 text-uppercase text-muted mt-1"> Messages
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <?php 
                        $contacts = EXECUTE_QUERY(SELECT_ALL("contacts", "id"));
                        
                        if (!empty($contacts)) {
                            foreach ($contacts as $message) { extract($message); ?>
                                ...
                                <div class="block-content block-content-full border-left border-3x border-info">
                                    <div class="d-md-flex justify-content-md-between align-items-md-center">
                                        <div class="p-1 p-md-3">
                                            <h3 class="h4 font-w700 mb-1"><?= $subject; ?></h3>
                                        ...
                                        <div class="p-1 p-md-3">
                                            ...
                                            <a class="btn btn-sm btn-alt-danger btn-rounded px-3 my-1" data-id="<?= $id; ?>" onclick="deletecontact(this)">
