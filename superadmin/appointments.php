...
<?php require_once './inc/header.php'; ?>
            ...
            <main id="main-container">
                ...
                <div class="content content-full">
                    <!-- Overview -->
                    <h2 class="font-w300 mt-4 mb-3">Appointments</h2>
                    <div class="row">
                            ...
                            <div class="block block-rounded block-fx-pop text-center">
                                <div class="block-content block-content-full d-flex justify-content-center align-items-center">
                                    <div>
                                        ...
                                        <div class="font-size-sm font-w600 text-uppercase text-muted mt-1"> Appointments
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <?php 
                        $appointments = EXECUTE_QUERY(SELECT_ALL("appointments", "id"));
                        
                        if (!empty($appointments)) {
                            foreach ($appointments as $appointment) { extract($appointment); ?>
                                ...
                                <div class="block-content block-content-full border-left border-3x border-info">
                                    <div class="d-md-flex justify-content-md-between align-items-md-center">
                                        <div class="p-1 p-md-3">
                                            <h3 class="h4 font-w700 mb-1"><?= $fullname; ?></h3>
                                            <p class="font-size-sm mb-0">
                                            Phone Number: <i><?= $phone ?></i> 
                                            </p>
                                            <p class="font-size-sm mb-0">
                                        ...
                                        <div class="p-1 p-md-3">
                                            ...
                                            <a class="btn btn-sm btn-alt-danger btn-rounded px-3 my-1" data-id="<?= $id; ?>" onclick="deleteappointment(this)">
