...
if (!isset($_GET['event_id'])) {
    ...
    $events = EXECUTE_QUERY(SELECT_WHERE("events", "event_id", $id));
            ...
            <main id="main-container">
                ...
                <div class="content content-full">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h2 class="font-w300 mb-0"><?= $event['event_title']; ?></h2>
                        <a href="<?= FORMAT_URL('../event-details?' . $event_title); ?>" class="btn btn-primary btn-sm btn-primary btn-rounded px-3">
                            <i class="fa fa-link mr-1"></i> Visit Event
                        </a>
                    </div>
                        ...
                        <div class="block-content block-content-full border-left border-3x border-info">
                            <div class="d-md-flex justify-content-md-between align-items-md-center">
                                <div class="p-1 p-md-3">
                                    <h3 class="h4 font-w700 mb-1"><?= $event_title; ?></h3>
                                    <p class="font-size-sm mb-2">Venue: <?= $event_location; ?></p> <hr />
                                    <p class="font-size-sm mb-2"><?= $event_desc; ?></p>
                                    <p class="font-size-sm text-muted mb-0">
                                    Date: <i><?= HUMAN_DATE($event_date); ?></i> | 
                                    Time: <i><?= $event_time; ?></i>
                                    </p>
                                </div>
                                <div class="p-1 p-md-3">
                                    <a class="btn btn-sm btn-alt-danger btn-rounded px-3 my-1" data-id="<?= $event_id; ?>" onclick="deleteEvent(this)">
