...
<html lang="en">
    <head>
        ...
        <title>Enugu State Science and Technology</title>

        <meta name="description" content="Enugu State Science and Technology developed by World Brain Technology">
        <meta name="author" content="World Brain Technology">
        <meta name="robots" content="noindex, nofollow">

        <!-- Open Graph Meta -->
        <meta property="og:title" content="Enugu State Science and Technology">
        <meta property="og:site_name" content="Enugu State Science and Technology">
        <meta property="og:description" content="Enugu State Science and Technology developed by World Brain Technology">
        ...
        <link rel="shortcut icon" href="../assets/img/logo//Enugu_State_Government.png">
        <link rel="icon" type="image/png" sizes="192x192" href="../assets/img/logo//Enugu_State_Government.png">
        <link rel="apple-touch-icon" sizes="180x180" href="../assets/img/logo//Enugu_State_Government.png">
        <!-- END Icons -->
            ...
            <nav id="sidebar" aria-label="Main Navigation">
                ...
                <div class="smini-hidden">
                    <div class="content-header justify-content-lg-center bg-black-10">
                        <!-- Logo -->
                        <a class="font-w600 text-white tracking-wide" href="index.html">
                            Ad<span class="opacity-75">min</span>
                            <span class="font-w400">Space</span>
                        </a>
                        <!-- END Logo -->
                ...
                <div class="js-sidebar-scroll">
                    ...
                    <div class="content-side">
                        <ul class="nav-main">
                            ...
                            <li class="nav-main-heading">Site</li>
                            <li class="nav-main-item">
                                ...
                                <ul class="nav-main-submenu">
                                    <li class="nav-main-item">
                                        <a class="nav-main-link" onclick="Dashmix.block('open', '#dm-add-domain');">
                                            <span class="nav-main-link-name">Add Project</span>
                                        </a>
                                    </li>
                                    <li class="nav-main-item">
                                        <a class="nav-main-link" href="projects">
                                            <span class="nav-main-link-name">View Projects</span>
                                            <span class="nav-main-link-badge badge badge-pill badge-success"><?= GET_TOTAL('projects'); ?></span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="nav-main-item">
                                <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="#">
                                    <i class="nav-main-link-icon fa fa-chess-queen"></i>
                                    <span class="nav-main-link-name">Events</span>
                                </a>
                                <ul class="nav-main-submenu">
                                    <li class="nav-main-item">
                                        <a class="nav-main-link" onclick="Dashmix.block('open', '#dm-add-event');">
                                            <span class="nav-main-link-name">Add Event</span>
                                        </a>
                                    </li>
                                    <li class="nav-main-item">
                                        <a class="nav-main-link" href="events">
                                            <span class="nav-main-link-name">View Events</span>
                                            <span class="nav-main-link-badge badge badge-pill badge-success"><?= GET_TOTAL('events'); ?></span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="nav-main-item">
                                ...
                                <ul class="nav-main-submenu">
                                    ...
                                    <li class="nav-main-item">
                                        <a class="nav-main-link" href="">
                                            <span class="nav-main-link-name">View Articles</span>
                                            <span class="nav-main-link-badge badge badge-pill badge-success"><?= GET_TOTAL('articles'); ?></span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="nav-main-item">
                                ...
                                <ul class="nav-main-submenu">
                                    <li class="nav-main-item">
                                        <a class="nav-main-link" href="appointments">
                                            <span class="nav-main-link-name">Appointments</span>
                                            <span class="nav-main-link-badge badge badge-pill badge-success"><?= GET_TOTAL('appointments'); ?></span>
                                        </a>
                                    </li>
                                    <li class="nav-main-item">
                                        <a class="nav-main-link" href="messages">
                                            <span class="nav-main-link-name">Direct Message</span>
                                            <span class="nav-main-link-badge badge badge-pill badge-success"><?= GET_TOTAL('contacts'); ?></span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="nav-main-item">
                                <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true" aria-expanded="false" href="users">
                                ...
                                <ul class="nav-main-submenu">
                                    <li class="nav-main-item">
                                        <a class="nav-main-link" href="users">
                                            ...
                                            <span class="nav-main-link-badge badge badge-pill badge-success"><?= GET_TOTAL('emails'); ?></span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
