...
<head>
    ...
    <title>EnuguSciTech| Enugu State Government Science and Technology Center</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <link rel="manifest" href="site.webmanifest">
    <link rel="shortcut icon" type="image/x-icon" href="assets/img/logo/Enugu_State_Government.png">
                            ...
                            <div class="tp-header-top-info">
                                <div class="tp-header-top-info-single pr-40 mr-40 border-right-1">
                                    ...
                                    <div class="tp-header-top-info-single-text">
                                        <span class="tp-header-top-info-single-label">Official Website</span>
                                        <span class="tp-header-top-info-single-content font-medium">Enugu State Government <br> Science and Technology</span>
                                    </div>
                                </div>
                                <div class="tp-header-top-info-single">
                                    ...
                                    <div class="tp-header-top-info-single-text">
                                        ...
                                        <a href="mailto:info@enugustate.com" class="tp-header-top-info-single-content font-medium">info@enugustate.com</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xxl-4 col-xl-5">
                            <div class="tp-header-top-info justify-content-end">
                                <div class="tp-header-top-info-single mr-85">
                                    ...
                                    <div class="tp-header-top-info-single-text">
                                        <span class="tp-header-top-info-single-label">SMS Only</span>
                                        <a href="tel:+234(0)094804822" class="tp-header-top-info-single-content font-medium">+234(0)094804822</a>
                                    </div>
                                </div>
                                <div class="tp-header-top-info-single">
            ...
            <div class="side-info-content">
                ...
                <div class="contact-infos mb-30">
                    <div class="contact-list mb-30">
                        <h4>Contact Info</h4>
                        <ul>
                            <li><i class="flaticon-pin"></i>Enugu State Govt Science & Tech</li>
                            <li><i class="flaticon-email"></i><a href="mailto:info@enugustate.com">info@enugustate.com</a></li>
                            <li><i class="flaticon-phone-call"></i><a href="tel:+234(0)812989485">+234(0)812989485</a></li>
                        </ul>
